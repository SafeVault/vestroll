  ...
  return (
    <Select>
      <SelectTrigger className="py-3 px-2 bg-[#F5F6F7]">
        <SelectValue placeholder={<SVGIcon iconName="@public/nigeria.svg" />} />
      </SelectTrigger>
      <SelectContent>
        <SelectGroup>
          <SelectItem value="+234">
            <SVGIcon iconName="@public/nigeria.svg" />
          </SelectItem>
  ...
  /**
     ...
     * <div className="flex items-center">
            <button
              ...
              className="shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
              type="button"
            >
              <svg
                aria-hidden="true"
